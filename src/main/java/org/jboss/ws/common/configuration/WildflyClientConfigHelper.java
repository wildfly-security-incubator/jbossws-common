...
class WildflyClientConfigHelper {
    ...
    static ClientConfig getConfiguredClient(WildflyClientSecurityConfigProvider wildflyConfigProvider, BindingProvider port) throws WildflyClientConfigException, URISyntaxException {
